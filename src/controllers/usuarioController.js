...
function cadastrar(req, res) {
  ...
  .then(function (res_usuario) {
    ...
    enderecoModel.cadastrar(dados_endereco)
    .then(function (res_endereco) {
      console.log("res_endereco:")
      console.log(res_endereco)

      vinicolaModel.cadastrar(dados_vinicola, res_usuario.insertId, res_endereco.insertId)
    ...
    .catch(function (erro) {
      console.log("\nHouve um erro ao realizar o cadastro do endereço! Erro: ", erro.sqlMessage);
      res.status(500).json(erro.sqlMessage);
      return
    })
